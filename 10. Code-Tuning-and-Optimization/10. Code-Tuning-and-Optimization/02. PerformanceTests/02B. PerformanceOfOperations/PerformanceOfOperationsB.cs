namespace _02B.PerformanceOfOperations
{
    using System;
    using System.Diagnostics;

    public class PerformanceOfOperationsB
    {
        ...
        public static void Main()
        {
            ...
            stopwatch.Stop();
            Console.WriteLine("Float square root: " + stopwatch.Elapsed);
            stopwatch.Reset();

            stopwatch.Start();
            PerformSquareRootOnDoubleValue();
            stopwatch.Stop();
            Console.WriteLine("Double square root: " + stopwatch.Elapsed);
            stopwatch.Reset();

            stopwatch.Start();
            PerformSquareRootOnDecimalValue();
            stopwatch.Stop();
            Console.WriteLine("Decimal square root: " + stopwatch.Elapsed);
            stopwatch.Reset();
            ...
            stopwatch.Stop();
            Console.WriteLine("Float natural logarith: " + stopwatch.Elapsed);
            stopwatch.Reset();

            stopwatch.Start();
            PerformNaturalLogarithmOnDoubleValue();
            stopwatch.Stop();
            Console.WriteLine("Double natural logarith: " + stopwatch.Elapsed);
            stopwatch.Reset();

            stopwatch.Start();
            PerformNaturalLogarithmOnDecimalValue();
            stopwatch.Stop();
            Console.WriteLine("Decimal natural logarith: " + stopwatch.Elapsed);
            stopwatch.Reset();
            ...
            stopwatch.Stop();
            Console.WriteLine("Float sine: " + stopwatch.Elapsed);
            stopwatch.Reset();

            stopwatch.Start();
            PerformSineOnDoubleValue();
            stopwatch.Stop();
            Console.WriteLine("Double sine: " + stopwatch.Elapsed);
            stopwatch.Reset();

            stopwatch.Start();
            PerformSineOnDecimalValue();
            stopwatch.Stop();
            Console.WriteLine("Decimal sine: " + stopwatch.Elapsed);
            stopwatch.Reset();
        }
